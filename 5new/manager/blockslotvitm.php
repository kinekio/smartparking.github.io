...
if(!$conn){  
  echo "<script type='text/javascript'>alert('Database failed');</script>";
    ...
    echo '<script>location.href = "blockslot.php";</script>';
}
...
$booking = mysqli_query($conn,"UPDATE vit_m SET status ='Blocked' WHERE spot_id=".$postcodes[$x]."");
 if(!$conn){  
  echo "<script type='text/javascript'>alert('Database failed');</script>";
    die('Could not connect: '.mysqli_connect_error());  
}
